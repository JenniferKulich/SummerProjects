...
//function that will move the left facing Z block right or left
void move1ZBlock(char boardColors[][10], char colorName, int &startSpot, int userMove, int row)
{
	//start spot is the top middle block of normal Z
	...
	if (userMove == 1)
	{
		...
		boardColors[row + 1][startSpot - 1] ==0)
		{
...
//function that will move the up facing Z block right or left
...
//function that will turn the left facing Z block to up facing
...
//function that will turn the up facing Z block to left facing
...
//function that will move the left facing Z block down
...
//function that will move the up facing Z block down
